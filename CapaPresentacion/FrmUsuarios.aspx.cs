...
namespace CapaPresentacion
{
    public partial class FrmUsuarios : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static Respuesta<List<ERol>> ObtenerRoles()
        {
            try
            {
                Respuesta<List<ERol>> Lista = NCarrera.GetInstance().ObtenerRoles();
                return Lista;
            }
            catch (Exception ex)
            {
        ...
        public static Respuesta<List<EUsuario>> ObtenerUsuario()
        {
            try
            {
                Respuesta<List<EUsuario>> Lista = NUsuario.GetInstance().ObtenerUsuariosZ();
                return Lista;
            }
            catch (Exception ex)
            {
        ...
        public static Respuesta<bool> GuardarUsua(EUsuario oUsuario, byte[] imageBytes)
        {
            try
            {
                ...
                EUsuario obj = new EUsuario
                {
                    ...
                    TokenSesion = Guid.NewGuid().ToString() // Generar nuevo TokenSesion
                };

                // Registrar el usuario respuesta.Estado
                Respuesta<bool> respuesta = NUsuario.GetInstance().Registrar(obj);
